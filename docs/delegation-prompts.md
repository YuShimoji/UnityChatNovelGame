...
| 優先 | タスク | 所要時間 | 前提 |
|------|--------|----------|------|
| 1 | Task A: MessageTagged 統一 | 1-2時間 | なし |
| 1 | Task B: 文字化けコメント | 1-2時間 | なし |
| 2 | Task F: generatedSprite=null | 半日 | なし |
| 2 | Task D: 名前重複防止 | 半日 | なし |
| 3 | Task E: 画面リサイズ | 1日 | なし |
| 4 | Task C: オートセーブ | 1-2日 | Task D 推奨 |

Task A と B は完全独立。同時に2セッションで実行可能。
