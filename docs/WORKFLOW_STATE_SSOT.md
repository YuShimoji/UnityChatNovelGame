...
**Updated**: 2026-03-13
**Phase**: バブルUIバグ修正中 — 角丸スプライト生成失敗・名前行リッチテキストスコープ・Hubループ
**Branch**: main
...
- [ ] 矛盾 Phase 2 の動作確認（手動: セットアップ + 再生テスト）— 未確認
...
| 4b | 角丸スプライト生成失敗修正 | A | — | **要修正** (generatedSprite=null) |
| 4c | 名前行リッチテキストスコープ修正 | A | — | **要修正** (斜体が名前に伝播) |
| 4d | Hub選択肢ループ修正 | A | — | **要調査** (全トピック消化後の終了条件) |
