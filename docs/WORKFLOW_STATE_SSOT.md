...
| # | 作業 | 分類 | 前提 | 状態 |
| --- | ------ | ---- | ------ | ------ |
| 1 | ダッシュボード + 矛盾 Phase 2 セットアップ + 動作確認 | A | Unity 手動 | 待ち |
| 2 | 発見バグの修正（あれば） | A | #1 結果 | 待ち |
| 3 | ~~インベントリ UI~~ | A | — | **済** (2026-03-11) |
| 4 | チャットバブル表示 + スクロール修正の動作確認 | A | Unity 手動 | 待ち |
| 5 | スマホサイズ基準レイアウト調整 | B | #4 確認後 | 未着手 |
| 6 | Ch3 シナリオ設計 | A | #1-2 完了後 | 未着手 |
