...
- [x] PlayModeスモークテスト追加（Title -> Chat -> Save/Load）
- [x] 失敗時の証跡保存（スクリーンショット/ログ）を自動化
- [x] 手動チェックリストをレポートに整備
- [x] レポート作成: docs/inbox/REPORT_TASK_047_VerticalSliceSmokeGate.md
- [ ] PlayMode/Build 実行結果の記録（実行待ち）
